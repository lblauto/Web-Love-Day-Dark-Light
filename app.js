...
var isDarkMode = false; // Ban đầu là màu sáng
...
function toggleDarkMode() {
  if ((isDarkMode && this === moonIcon) || (!isDarkMode && this === sunIcon)) {
    return; // Không cần thay đổi trạng thái nếu người dùng nhấn liên tiếp cùng biểu tượng
  }

  isDarkMode = !isDarkMode; // Đảo ngược trạng thái

  if (isDarkMode) {
    document.body.classList.add("dark-mode"); // Thêm lớp dark-mode cho thẻ body
    moonIcon.style.display = "none"; // Ẩn biểu tượng mặt trăng
    sunIcon.style.display = "block"; // Hiển thị biểu tượng mặt trời
    sunIcon.style.display = "flex";

    moonIcon.classList.remove("dark-night i"); // Loại bỏ class dark-night
    sunIcon.classList.add("dark-night i"); // Thêm class dark-night
} else {
    document.body.classList.remove("dark-mode"); // Loại bỏ lớp dark-mode khỏi thẻ body
    moonIcon.style.display = "block"; // Hiển thị biểu tượng mặt trăng
    sunIcon.style.display = "none"; // Ẩn biểu tượng mặt trời
    moonIcon.style.display = "flex";

    sunIcon.classList.remove("dark-night i"); // Loại bỏ class dark-night
    moonIcon.classList.add("dark-night i"); // Thêm class dark-night
}
}